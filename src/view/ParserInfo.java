...
public class ParserInfo{
    ...
    public void initialize(ParserGenerator parserGenerator,ArrayList<String> terminals) {
        try {
            ...
            ArrayList<Pair<String,Pair<String,String>>> firstFollowSets = getParsingFirstFollow(parserGenerator.getNonTerminals(),parserGenerator.getFirstSet(),parserGenerator.getFollowSet());
    ...
    private void showParsingData(ArrayList<Pair<String,Pair<String,String>>> parserFirstFollowSets) {
        ...
        for (Pair<String,Pair<String,String>> dataValue : parserFirstFollowSets) {
            data.add(new InfoModelFirstFollow(dataValue.getKey(),dataValue.getValue().getKey(),dataValue.getValue().getValue()));
        }
        dataParserFirstFollowTable.setItems(data);
    }
    private void showParsingTable(ArrayList<String> terminals,ArrayList<Pair<String,Pair<String,String>>> parserFirstFollowSets,HashMap<String, HashMap<String, ArrayList<ArrayList<String>>>> parsingTable) {
